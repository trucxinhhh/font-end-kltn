...
import * as Thresh from "./include/DefaultData.jsx";
...
function App() {
  ...
  const logos = [
    { src: "src/assets/logo/daiviet.jpg", alt: "Dai Viet Logo" },
    { src: "src/assets/logo/fet.jpg", alt: "FET Logo" },
    { src: "src/assets/logo/iuh.jpg", alt: "IUH Logo" },
  ];
  ...
  const handleTouchEnd = () => {
    ...
    // Reset swipe direction and start position
        ...
        <div className="flex  h-full w-full ">
          ...
          <div className="p-4 w-full md:w-1/2">
            ...
            <div className="flex left-1">
              <div className=" flex flex-col  items-center h- w-4/6 p-2 shadow-xl bg-cyan-900 text-white rounded-3xl mr-2 ">
                <h3 className="mt-2 text-2xl font-bold">{today}</h3>
                <h3 className="mt-2 text-2xl font-bold">{currentTime}</h3>
              </div>
              <div className="flex flex-col items-center  w-4/6 p-2  shadow-xl bg-cyan-900 text-white rounded-3xl mr-2">
          ...
          <div className=" p-4 w-1/2  rounded-r-3xl hidden md:block ">
            ...
            <div className="flex flex-col h-1/2 w-full mx-auto my-2 justify-between  bg-white">
              <img src="src/assets/logo/iuh.jpg" className="h-22 w-32"></img>
              <img src="src/assets/logo/fet.jpg" className="h-22 w-32"></img>
              <img
                src="src/assets/logo/daiviet.jpg"
                className="h-22 w-32"
              ></img>
            </div>
          </div>
